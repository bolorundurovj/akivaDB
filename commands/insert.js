...
const insert = (document, collection) => {
...
const createInsertObject = (keys, document) => {
  const insertObj = {};
...
const insertObjectOnCollection = (insertObj, collectionName) => {
...
const updateCollectionIndexes = (insertObj, collectionMetadata) => {
