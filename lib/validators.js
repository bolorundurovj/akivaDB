...
const isModifier = (x) => (0, exports.isObject)(x) &&
    dot.every(x, (entry) => !(0, exports.hasKey)(entry, "$deleted") && !(0, exports.hasKey)(entry, "_id"));
 ...
 * @returns {boolean} boolean
 */
const isUpdate = (x) => (0, exports.isObject)(x) && !((0, exports.isDoc)(x) && (0, exports.isModifier)(x)) && ((0, exports.isDoc)(x) || (0, exports.isModifier)(x));
