...
BTree = function (rootNode) {
  return {
    ...
    delete: function (value) {
      const node = typeof value === 'number' ? this.find(value) : value
    ...
    _delete: function (node) {
      ...
      if (node.left === null && node.right === null) {
        ...
        const replacementNode = this.max(node.left)
    ...
    rotateLeft: function (node) {
      ...
      const child_left_child = child.left
    ...
    rotateRight: function (node) {
      ...
      const child_right_child = child.right
...
const _IndexJsonToBTree = function (currentNodeJson, parent) {
  ...
  const node = BTreeNode(currentNodeJson.value, currentNodeJson.add)
