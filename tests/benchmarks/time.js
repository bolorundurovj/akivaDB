...
const inmemory = new AkivaDB({ name: 'inmemory', root: 'akivadb', inMemory: true });
...
console.log('/****************** Test for ' + x + ' documents(s) persisted *************/');
...
(async () => {
    await saved.update({ title: 'AkivaDB rocks 1' }, 'title', 'AkivaDB is awesome');
})()
